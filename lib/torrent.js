...
export default class Torrent extends EventEmitter {
  constructor (torrentId, client, opts) {
    ...
    // latest tracker announce messages
    this.trackerAnnounced = {};
  ...
  _startDiscovery () {
    ...
    this.discovery.on('trackerAnnounce', (updateMessage) => {
      updateMessage.time = new Date().getTime();
      this.trackerAnnounced[updateMessage.announce] = updateMessage;
      this.emit('trackerAnnounce', updateMessage)
    })
